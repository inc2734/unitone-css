...
export const Default = (args) => {
  return (
    <Switcher {...args}>
      <Decorator backgroundColor="#decc00" padding={ 1 }>Lorem ipsum</Decorator>
      <Decorator backgroundColor="#bfb6a8" padding={ 1 }>dolor sit</Decorator>
      <Decorator backgroundColor="#edede6" padding={ 1 }>amet consectetur</Decorator>
    </Switcher>
  );
};
