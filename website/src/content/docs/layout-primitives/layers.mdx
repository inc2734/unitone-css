...
Establish an ancestor query container with `-container-type:inline-size` in HTML or `<Decorator containerType="inline-size">` in React.
...
<Tabs items={['HTML', 'JSX', 'Preview']}>
	...
	<Tabs.Tab>
		...
		<Decorator maxWidth="375px" containerType="inline-size">
